...
### Execução
Após clonar o repositório com ```git clone https://github.com/duskzi/todo-list-api``` ou descompactar o diretório baixado, vá a pasta /src e execute ```node app.js```
